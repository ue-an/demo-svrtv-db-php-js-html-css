<div class="row" id="row-anawimtable">
    <!-- <div class="row"> -->
    <!-- <div class="col-lg-6">
    ...
    <!-- </div> -->
    <div class="col-lg-12">
    <table class="table table-light table-hover table-bordered table-striped" id="anawim-tbl">
            <thead>
                <tr class="table-primary text-dark bg-gradient bg-opacity-150">
                    <th class="px-1 py-1 text-center">Anawim ID</th>
                    ...
                    <th class="px-1 py-1 text-center">Monthly Donation</th>
